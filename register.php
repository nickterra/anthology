...
<html>
<head>
	<title>Welcome to Anthology!</title>
...
<body>
	...
	<div id="loginContainer">
		...
		<div id="loginText">
			<h1>Expand your reading list today!</h1>
			<h2>Stream dozens of audiobooks in one app!</h2>
			<ul>
				<li>Discover audiobooks</li>
				<li>Create your own personal reading lists</li>
				<li>Follow writers to keep up to date</li>
			</ul>
		</div>
	</div>
</div>
